...
-(void)addObserver{
    [_scrollView removeObserver:self forKeyPath:MJRefreshContentOffset context:nil];
    [_scrollView addObserver:self forKeyPath:MJRefreshContentOffset options:NSKeyValueObservingOptionNew context:nil];
}
...
- (void)free
{
    if (_scrollView) {
        ...
        NSLog(@"_scrollView be nil,sure removeObserver");
    }
